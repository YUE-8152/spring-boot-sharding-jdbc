package com.cardlan.sharding.jdbc.common.constant;

/**
 * 项目常量
 */
public final class GeneratorConstant {
    public static final String BASE_PACKAGE = "com.cardlan.sharding.jdbc";//生成代码所在的基础包名称，可根据自己公司的项目修改（注意：这个配置修改之后需要手工修改src目录项目默认的包路径，使其保持一致，不然会找不到类）
